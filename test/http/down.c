...
int HTTP_GetFileSize(int sockfd, const char *path)
{
    int ret = -1;
    char buf_recv_tmp[10*1024+1];
...
{
    HTTP_DownloadFile("http://113.107.239.241:9201/danGeLianXu.m3u8", "./");
    //HTTP_DownloadFile("http://fanhe.dwstatic.com/shortvideo/02/20163/015/3d93b82e0fb8e756838cf9c1fac10000.mp4", "./");
    return 0;
}